...
const createOrder = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body, { items } = _a, orderDetails = __rest(_a, ["items"]);
    const result = yield order_service_1.OrderServices.createOrderIntoDB(Object.assign({ items }, orderDetails));
